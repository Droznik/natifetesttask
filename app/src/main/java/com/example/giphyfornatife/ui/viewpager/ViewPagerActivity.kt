package com.example.giphyfornatife.ui.viewpager

import android.os.Bundle
import androidx.appcompat.app.AppCompatActivity
import androidx.viewpager2.widget.ViewPager2
import com.example.giphyfornatife.R
import com.example.giphyfornatife.databinding.ViewPagerBinding
...
class ViewPagerActivity: AppCompatActivity() {
    ...
    private fun setupViewPager(position: Int, data: List<String>) {
        ...
        viewpager.setOnClickListener { onBackPressed() }
    }
